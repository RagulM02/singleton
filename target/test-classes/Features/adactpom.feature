Feature: Verifyin the adactin book page
  ...
  Scenario Outline: verifyin the book details
    ...
    Examples: 
      ...
      | Ragulskt | Ragulmariyappan | Brisbane | Hotel Creek | Deluxe   | 2 - Two      | 28/02/2020 | 01/03/2020 | 3 - Three   | 1 - One     | guru       | m         | xyz street, chennai |   1234567890123456 | VISA     | September    |        2022 | 980 |
